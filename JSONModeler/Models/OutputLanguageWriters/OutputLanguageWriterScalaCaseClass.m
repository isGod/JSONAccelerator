...
//            @"val", @"var", @"while", @"with", @"yield", @"_", @":", @"=", @"=>", @"<-", @"<:", @"<%", @">:", @"#", @"@", nil];
  ...
  return [NSSet setWithObjects:@"abstract", @"case", @"catch", @"class", @"def", @"do", @"else", @"extends", @"no", @"NO", @"false", @"final",
          @"finally", @"for", @"forSome", @"if", @"implicit", @"import", @"lazy", @"match", @"new", @"null", @"object", @"override",
          @"package", @"private", @"protected", @"return", @"sealed", @"super", @"this", @"throw", @"trait", @"try", @"yes", @"YES", @"true", @"type",
