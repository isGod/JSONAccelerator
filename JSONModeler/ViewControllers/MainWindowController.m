...
- (void)generateFiles {
    ...
    self.languageChooserViewController = [[SavePanelLanguageChooserViewController alloc] initWithNibName:@"SavePanelLanguageChooserViewController" bundle:nil];//“选项”功能视图
    self.panel.accessoryView = self.languageChooserViewController.view;
    self.panel.accessoryViewDisclosed = YES;//打开底部“选项”功能视图
